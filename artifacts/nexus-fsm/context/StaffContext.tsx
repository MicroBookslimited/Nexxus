...
const STAFF_SESSION_KEY = 'fsm_staff_session';
...
export function StaffProvider({ children }: { children: React.ReactNode }) {
  ...
  const setStaff = (s: StaffSession | null) => {
    setStaffState(s);
    if (s) void AsyncStorage.setItem(STAFF_SESSION_KEY, JSON.stringify(s));
    else void AsyncStorage.removeItem(STAFF_SESSION_KEY);
  };
