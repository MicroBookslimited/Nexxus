  ...
  return (
    ...
    >
      ...
      {canViewReports ? (
        ...
        /* Restricted view for Cashiers — no financial data */
        <div className="space-y-6">
          {/* Neutral notice */}
          <div className="flex items-start gap-3 rounded-lg border border-border bg-secondary/20 px-5 py-4">
            <ShieldOff className="h-5 w-5 text-muted-foreground mt-0.5 shrink-0" />
            <div>
              <p className="text-sm font-medium">Financial data is restricted</p>
              <p className="text-xs text-muted-foreground mt-0.5">
                Revenue, sales totals, and performance metrics are only visible to managers and supervisors.
              </p>
            </div>
          </div>

          {/* Recent orders — safe for cashiers */}
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Recent Orders</CardTitle>
            </CardHeader>
