...
const landingCss = `
  ...
  .glass-card { background: rgba(26,35,50,0.7); border: 1px solid rgba(59,130,246,0.12); backdrop-filter: blur(8px); }
  .card-hover { transition: all 0.2s ease; }
  .card-hover:hover { transform: translateY(-2px); border-color: rgba(59,130,246,0.3); }
  .hero-glow { background: radial-gradient(ellipse 80% 50% at 50% -20%, rgba(59,130,246,0.12), transparent); }
  .section-glow { background: radial-gradient(ellipse 60% 40% at 50% 100%, rgba(59,130,246,0.06), transparent); }
...
export default function Landing() {
  return (
    <div style={{ background: "#0f1729", color: "#f1f5f9", fontFamily: "system-ui, -apple-system, sans-serif", minHeight: "100vh" }}>
